...
export const LocalConciergeWidget = () => {
  ...
  return (
    <div className="fixed bottom-[calc(4.8rem+env(safe-area-inset-bottom))] md:bottom-6 right-4 sm:right-6 z-[60] font-sans">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-4 w-[calc(100vw-2rem)] sm:w-[380px] md:w-[400px] h-[min(550px,calc(100vh-140px))] bg-white rounded-[2rem] shadow-2xl border border-slate-100 flex flex-col overflow-hidden"
          >
            {/* Header */}
