...
export default function BlogPost() {
  ...
  const handleShare = async () => {
    ...
    const shareData = {
      title: post.title,
      text: post.excerpt || `Leia "${post.title}" no Blog Oficial.`,
        ...
        <header className="mb-10">
          ...
          <div className="flex items-center justify-between pb-8 border-b border-slate-200">
             ...
             <Button 
               ...
               className="rounded-xl h-12 w-12 border-slate-200 hover:text-primary hover:border-primary hover:bg-slate-50 transition-all shadow-sm"
             >
