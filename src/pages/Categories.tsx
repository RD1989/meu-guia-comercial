          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white p-4 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 flex items-center gap-4">
              ...
              <input 
                ...
                className="flex-1 bg-transparent border-none outline-none focus:ring-0 text-sm font-bold text-slate-700"
              />
              {searchTerm && (
                <button 
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {isLoading ? (
                ...
                <div className="col-span-full py-16 text-center bg-white rounded-3xl border border-dashed border-slate-200">
                  <p className="font-bold text-slate-500 text-sm">Nenhuma categoria encontrada para "{searchTerm}"</p>
                </div>
              ) : (
            ...
            <div className="bg-primary rounded-[2.5rem] p-8 text-white relative overflow-hidden group">
               ...
               <div className="relative z-10">
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    className="w-full bg-white text-primary border-none font-black rounded-xl hover:bg-slate-100"
                  >
                    Saiba Mais
                  </Button>
               </div>
                  ...
                  {categories.slice(0, 5).map((cat: any) => (
                    ...
                    >
                       <div className="flex items-center gap-3">
                          <div className={cn("h-8 w-8 rounded-lg flex items-center justify-center border", COLOR_MAP[cat.color] || "text-primary bg-primary/5")}>
